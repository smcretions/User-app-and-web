...
abstract class BusinessServiceInterface{
  ...
  Future<String> processesBusinessPlan(String businessPlanStatus, int paymentIndex, int restaurantId, PackageModel? packageModel, String? digitalPaymentName, int? selectedPackageId);
